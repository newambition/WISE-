...
import { Search, Brain, ShieldCheck, ChevronDown } from 'lucide-react';
...
const LandingPageContent = ({ onGetStartedClick, isLoading }) => {
      ...
      <div className="rounded-lg pt-8 pb-8 px-8 w-full  max-w-6xl">
        ...
        <div className="text-center space-y-12 mb-24">
          <h2 className="text-8xl font-bold text-black tracking-tighter">
            <div className="font-body mt-16">
              The age of persuasion requires a new kind of
            </div>
            <span className="text-primary text-8xl font-black font-heading mb-16 tracking-tighter">
              intelligence
            </span>
          </h2>

          <h2 className="text-3xl font-semibold text-black mb-12 tracking-tighter">
            We believe it's not about telling people what to think,<br />
            but showing them how to see.
            <br />
            <span className="text-3xl text-info font-bold mt-12 block">WISE is a completely free tool designed to empower your critical thinking.</span>
          </h2>
          ...
          <div className="flex justify-center">
            <button
              ...
              disabled={isLoading}
              className={`font-semibold text-md px-8 py-3 mb-6 rounded-2xl shadow transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-primary focus-visible:ring-accent bg-primary text-primary-content hover:brightness-110 disabled:cursor-wait disabled:brightness-90 flex items-center`}
            >
          ...
          <div className="flex flex-col items-center mb-16">
            <span className="text-3xl font-semibold text-black mb-2 tracking-tighter">or read more</span>
            <ChevronDown size={40} className="animate-bounce text-black" />
          </div>
        </div>
        ...
        <div className="relative">
          <div className="flex justify-between items-start mb-8">
            <div className="flex flex-col items-center flex-1 relative">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Get Started for Free</h3>
              <p className="text-center text-black/80 max-w-sm">
                WISE is a free tool. No credit card is needed. Get access to our Analysis Engine and educational content.
              </p>
            </div>
            ...
            <div className="group bg-base-200/50 border border-base-300 rounded-lg shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-info/20 relative">
              <div className="p-6">
                ...
                <div className="flex items-start mb-3">
                  <span className="text-2xl mr-3 opacity-80 group-hover:opacity-100 transition-opacity duration-300" role="img" aria-label="Assertion Icon"> {/* Check these icons if they were part of the issue */} </span>
                  <div>
          ...
          <div className="w-[450px]">
            <div className="group bg-base-200/50 border border-base-300 rounded-lg shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-info/20 relative">
              <div className="p-6">
                ...
                <div className="flex items-start mb-3">
                  <span className="text-2xl mr-3 opacity-80 group-hover:opacity-100 transition-opacity duration-300" role="img" aria-label="Fear Icon"> {/* Check these icons if they were part of the issue */} </span>
                  <div>
